...
class Store extends Component{
    ...
    deleteit=(name,url)=>
    {
        ...
        {
        const wordRef=firebase.database().ref("users").child(url)
        const wordRef1=firebase.database().ref("userss").child(url)
        wordRef.remove()
        wordRef1.remove()
...
<div className="card col-sm mt-3 mb-3 ml-3 mr-3 rounded mb-3" style={{width:"18rem",border: "6px solid black"}}>
  <img className="card-img-top" src={"https://api.rethumb.com/v1/height/250/version/xc38/"+word.url} alt="Card image cap"/> 
